...
<body>
	...
	<div class="footer">
		...
		<table class="table" ="table">
			...
			<tr>
				<td>
					<form id="mrButtons" action="">
						<input type="submit" src="https://i.imgur.com/pea2Bth.png"     width="100" height="75" form="mrButtons" >
				</form></td>
				<td>Mr. Buttons</td>
			...
			<tr>
				<td>
					<form id="freddyMeowcurry" action="">
						<input type="submit" src="https://i.imgur.com/pea2Bth.png"  width="100" height="75" form="freddyMeowcurry">
					</form></td>
			...
			<tr>
				<td>
					<form id="calicoJack" action="">
						<input type="submit" src="https://i.imgur.com/pea2Bth.png"  width="100" height="75" form="calicoJack">
					</form></td>
				<td>Calico Jack</td>
			...
			<tr>
				<td><img src="https://i.imgur.com/pea2Bth.png" title="source: imgur.com" width="100" height="75"/></td>
				<td>Spock</td>
				<td><img src="https://i.imgur.com/O8RxLUb.jpg" title="source: imgur.com" width="150" height="125" /></td>
				<td>$50</td>
			...
			<tr>
				...
				<td><img src="https://i.imgur.com/7t2X5tC.jpg" title="source: imgur.com" width="150" height="125" /></td>
				<td>$75</td>
			...
			<tr>
				<td><img src="https://i.imgur.com/pea2Bth.png" title="source: imgur.com" width="100" height="75"/></td>
				<td>Paul</td>
				<td><img src="https://i.imgur.com/aEwwYYG.jpg" title="source: imgur.com" width="125" height="125" /></td>
				<td>$20</td>
			...
			<tr>
				<td><img src="https://i.imgur.com/pea2Bth.png" title="source: imgur.com" width="100" height="75"/></td>
				<td>Licki Brush</td>
				<td><img src="https://i.imgur.com/2EyL6p3.jpg" title="source: imgur.com" width="150" height="125" /></td>
				<td>$25</td>
			...
			<tr>
				...
				<td><img src="https://i.imgur.com/LL3wOWR.jpg" title="source: imgur.com" width="150" height="125" /></td>
				<td>$50</td>
			...
			<tr>
				<td><img src="https://i.imgur.com/pea2Bth.png" title="source: imgur.com" width="100" height="75"/></td>
				<td>U-Pet Carrier</td>
				<td><img src="https://i.imgur.com/QWtoZ2S.jpg" title="source: imgur.com" width="125" height="125" /></td>
				<td>$35</td>
			...
			<tr>
				...
				<td><img src="https://i.imgur.com/Zjm0949.jpg" title="source: imgur.com" width="150" height="125" /></td>
				<td>$20</td>
